...
from dream.compressible.config import dimensionfulstate
...
class Scaling(InterfaceConfiguration, is_interface=True):
    ...
    def dimensionful_values(self, state: dimensionfulstate):
        ...
        """
        reference = dimensionfulstate({'L': 1, 'rho': 1.293, 'u': 1, 'c': 343, 'T': 293.15, 'p': 101325})
    ...
    dimensionful_values: dimensionfulstate
