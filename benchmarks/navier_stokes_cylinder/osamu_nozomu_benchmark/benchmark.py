from dream import CompressibleHDGSolver, SolverConfiguration, ResultsDirectoryTree, Loader, Saver, Perturbation
...
r = (r - sp_start)/sp_length
weight_function = 6*r**5 - 15*r**4 + 10*r**3
...
solver.domain_conditions.set_sponge_layer('sponge', weight_function, rho_inf,
                                          u_inf, pressure=p_inf, weight_function_order=5)
