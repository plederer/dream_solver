...
solver.boundary_conditions.set(bcs.CBC(farfield, type="grcbc", relaxation="outflow", convective_tangential_flux=True, viscous_fluxes=True, glue=False, sigma=State(velocity=0.1, pressure=0.1)), "right")
