...
from dream import *
from dream.compressible import Initial, CompressibleFlowSolver, flowfields, FarField, Outflow, InterfaceBC, InviscidWall
...
# Time information.
time_info = TimeInfo( t0=0.0, tf=2.0, dt=0.01 )
