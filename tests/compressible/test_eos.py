...
class TestIdealGas(unittest.TestCase):
    ...
    def test_density_gradient(self):
        ...
        dU = CompressibleStateGradient(grad_p=(1, 1), grad_T=(1, 0))
        nptest.assert_almost_equal(self.eos.density_gradient(U, dU)(mip), (0, 7/2))

        U = CompressibleState(T=1, rho_Ei=1)
        dU = CompressibleStateGradient(grad_T=(1, 1), grad_rho_Ei=(1, 0))
    ...
    def test_pressure_gradient(self):
        ...
        dU = CompressibleStateGradient(grad_rho=(1, 1), grad_T=(1, 0))
        nptest.assert_almost_equal(self.eos.pressure_gradient(U, dU)(mip), (4/7, 2/7))

        dU = CompressibleStateGradient(grad_rho_Ei=(1, 0))
    ...
    def test_temperature_gradient(self):
        ...
        dU = CompressibleStateGradient(grad_rho=(1, 0), grad_p=(1, 1))
        nptest.assert_almost_equal(self.eos.temperature_gradient(U, dU)(mip), (0, 7/2))

        dU = CompressibleStateGradient(grad_Ei=(1, 0))
    ...
    def test_characteristic_variables(self):
        ...
        dU = CompressibleStateGradient(grad_rho=(1, 0), grad_p=(0, 1), grad_u=(1, 0, 0, 1))
